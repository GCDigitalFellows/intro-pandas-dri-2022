...
* Sun Dec 19 2021 11:27:31 GMT-0800 (PST)
* Source doc: Pandas workshop
...
**Introduction to Data Wrangling, Cleaning, and Analysis with Python and Pandas**
...
In this workshop, we will use [Jupyter Notebooks](https://curriculum.dhinstitutes.org/insights/short-introduction-to-jupyter-notebooks/) to work with Pandas and you will learn how to:
...
**The Dataset and ethical consideration**
...
**Lesson 1: Preparing your workspace and folders**
...
Download the “refugee-arrivals-by-destination” CSV file and save it in the “pandas_workshop” folder on our Desktop. 
...
**Lesson 2: Working with Jupyter Notebook**
...
**Lesson 7: Rename, select, drop, and add new columns**
...
**Lesson 8: Sort Columns, Groupby Columns, & Count values**
...
**Lesson 9: Basic data visualizations**
...
**Lesson 11: Building your Pandas skills with the Pandas documentation and other resources**
